...
import {
  ...
  MarkIcon,
  resolveAgentMark,
} from "@/components/features/agents/AgentMark";
...
export function OAuthAuthorizeForm({
  ...
  const inferred =
    AGENT_MARKS.find((a) => a.mark === resolveAgentMark(clientName))?.id ??
    null;
      ...
      <div className="w-full max-w-sm">
        ...
        <div className="bg-neutral-900 border border-neutral-800 rounded-xl overflow-hidden">
          ...
          <div className="px-6 pt-5 pb-4 border-b border-neutral-800">
            <p className="text-xs text-neutral-500 uppercase tracking-wider mb-2.5">
              {t("accessLevel")}
            </p>
              ...
              {workspaces.map((ws) => {
                ...
                return (
                  ...
                  >
                    ...
                    <span
                      className={`flex-1 text-sm truncate ${active ? "text-blue-100" : "text-neutral-200"}`}
                    >
                      {ws.name}
                    </span>
                    {active && (
        ...
        <div className="mt-4 text-center">
          ...
          <p className="text-xs text-neutral-700 mt-3 px-4">
            {t("disclaimer")}
          </p>
        </div>
      </div>
