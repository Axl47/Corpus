...
export default function LoginPage() {
  ...
  const [demoState, demoFormAction, isDemoPending] = useActionState(
    loginAsDemo,
    null,
  );
  ...
  async function handleTauriSignIn() {
    ...
    try {
      ...
      console.error("[Corpus] openUrl failed:", err);
      setOpenUrlError(msg);
      deviceIdRef.current = null;
      setTauriState("error");
      return;
  ...
  if (isTauri) {
    return (
      <div className="min-h-screen bg-neutral-950 flex flex-col items-center justify-center p-4 select-none">
        ...
        />
        <h1 className="text-xl font-semibold text-white mb-10 tracking-tight">
          Corpus
        </h1>
