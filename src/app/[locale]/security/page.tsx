...
export const metadata: Metadata = {
  ...
  description:
    "How Corpus authenticates users and AI agents — Google/GitHub OAuth, MCP Personal Access Tokens, OAuth 2.1 + PKCE, token scopes, and responsible disclosure.",
  alternates: { canonical: "https://corpus.com/security" },
  openGraph: {
    title: "Security & Authentication | Corpus",
    description:
      "How Corpus authenticates users and AI agents — OAuth, MCP tokens, PKCE, audit logs, and responsible disclosure.",
    url: "https://corpus.com/security",
    siteName: "Corpus",
            ...
            {sections.map(({ icon: Icon, color, bg, title, body, badge }) => (
              ...
              >
                <div className="flex items-start gap-4">
                  <div
                    className={`flex h-9 w-9 items-center justify-center shrink-0 ${bg} ${color} mt-0.5`}
                  >
                    <Icon size={18} />
                  </div>
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-neutral-300 text-[13.5px] leading-[1.7]">
                      {body}
                    </p>
                  </div>
                </div>
