...
export default async function LandingSetup() {
  ...
  const steps = [
    {
      num: "01",
      titleKey: "bridgeSetup1Title",
      bodyKey: "bridgeSetup1Body",
      code: "https://corpus.com/login",
    },
    {
      num: "02",
      titleKey: "bridgeSetup2Title",
      bodyKey: "bridgeSetup2Body",
      code: t("bridgeSetupCode2"),
    },
    {
      num: "03",
      titleKey: "bridgeSetup3Title",
      bodyKey: "bridgeSetup3Body",
      code: '{"type":"http","url":"https://corpus.com/api/mcp"}',
    },
  ];
          ...
          {steps.map((s) => (
            ...
            >
              <div className="flex items-center gap-3.5 mb-[18px]">
                <span className="w-8 h-8 rounded-md bg-neutral-900 border border-neutral-800 inline-flex items-center justify-center font-mono text-[13px] text-accent-strong font-semibold">
                  {s.num}
                </span>
              ...
              <div className="mt-5 px-3 py-2 bg-neutral-900 border border-neutral-800 rounded font-mono text-xs text-accent-strong whitespace-nowrap overflow-hidden text-ellipsis">
                {s.code}
              </div>
            </div>
          ))}
