...
const AI_TILES = [
  {
    id: "claude",
    name: "Claude",
    sub: "Desktop · Claude Code",
    color: "#d97757",
    action: "creating page",
  },
  {
    id: "cursor",
    name: "Cursor",
    sub: "IDE · Composer",
    color: "#dfe2ea",
    action: "editing status",
  },
  {
    id: "antigravity",
    name: "Antigravity",
    sub: "Agent · Google Gemini",
    color: "#4d8df0",
    action: "removing page",
  },
] as const;
...
const KANBAN_COLS = [
  {
    ...
    cards: [
      {
        t: "Set up i18n message loader",
        tag: "infra",
        tc: "var(--color-opt-purple)",
      },
      {
        t: "Audit Auth.js session caching",
        tag: "perf",
        tc: "var(--color-opt-teal)",
      },
    ],
  },
  {
    ...
    cards: [
      {
        t: "Kanban segmented border accent",
        tag: "design",
        tc: "var(--color-opt-pink)",
      },
      {
        t: "Inline cell editor — date",
        tag: "editor",
        tc: "var(--color-amber-500)",
      },
    ],
  },
  {
  ...
  return (
    <section className="relative overflow-hidden px-4 sm:px-8 lg:px-14 pt-16 pb-12 lg:pt-[110px] lg:pb-[90px]">
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(circle, rgba(68,92,149,0.18), transparent 60%)",
        }}
      />
          ...
          <div>
            ...
            <div className="mt-8 lg:mt-10 space-y-2">
              <div className="flex border border-neutral-800 rounded-md overflow-hidden w-fit max-w-full">
                {[
                  {
                    num: t("bridgeHeroStat1Num"),
                    label: t("bridgeHeroStat1Label"),
                  },
                  {
                    num: t("bridgeHeroStat2Num"),
                    label: t("bridgeHeroStat2Label"),
                  },
                  {
                    num: t("bridgeHeroStat3Num"),
                    label: t("bridgeHeroStat3Label"),
                  },
                ].map((s, i) => (
                  <div
                    key={i}
          ...
          >
            ...
            <div
              ...
              style={{
                ...
                height: 32,
                background:
                  "linear-gradient(180deg, var(--color-blue-500), transparent)",
                opacity: 0.6,
              }}
            >
            ...
            <div
              ...
              style={{
                ...
                width: 220,
                background:
                  "linear-gradient(to right, transparent 0%, var(--color-neutral-950) 72%)",
              }}
            />
            <div
              ...
              style={{
                height: 130,
                background:
                  "linear-gradient(to bottom, transparent 0%, var(--color-neutral-950) 75%)",
              }}
            />
  ...
  return (
    <div
      ...
      style={{
        ...
        fontSize: 11,
        boxShadow:
          "0 32px 64px -16px rgba(0,0,0,0.55), 0 10px 20px -8px rgba(0,0,0,0.4)",
      }}
    >
      {/* Sidebar */}
      <div className="w-47 shrink-0 bg-neutral-900 border-r border-neutral-800 flex flex-col gap-1 px-2.5 py-3 text-[10px]">
        <div className="flex items-center gap-1.5 px-1.5 pb-2 mb-1.5 border-b border-neutral-800">
          <Image
            ...
            height={12}
          />
          <span className="font-semibold text-neutral-100 text-[11px]">
            Acme
          </span>
        ...
        {[
          ...
          <div
            key={it.t}
            className="flex items-center gap-1.5 px-1.5 py-0.5 rounded text-neutral-50"
          >
        ...
        {["🚀 Corpus v2 Launch", "🎨 Design System"].map((t) => (
          <div
            key={t}
            className="flex items-center gap-1.5 pl-5.5 py-0.5 text-dim"
            style={{
        ...
        <div
          className="flex items-center gap-1.5 px-1.5 py-0.5 rounded text-neutral-100"
          style={{ background: "rgba(68,92,149,0.18)" }}
        >
          <span>📊</span>
      ...
      <div className="flex-1 bg-neutral-850 flex flex-col min-w-0">
        ...
        <div className="border-b border-neutral-800 px-3 py-2 flex items-center gap-2.5 text-[10px]">
          {/* <span className="text-dim">Projects / Corpus v2 /</span> */}
          <span className="text-neutral-100 font-medium py-1">
            📊 Sprint Board
          </span>
          <span
          ...
          {KANBAN_COLS.map((col, colIdx) => (
            ...
            >
              <div className="flex items-center gap-1.5 px-0.5">
                ...
                />
                <span className="text-neutral-100 font-medium text-[10px]">
                  {col.name}
                </span>
              </div>
              {col.cards.map((c, cardIdx) => (
                ...
                >
                  <span className="text-neutral-100 text-[9.5px] leading-[1.35]">
                    {c.t}
                  </span>
                  <span
                    ...
                    style={{
                      color: c.tc,
                      background: `color-mix(in oklab, ${c.tc} 14%, transparent)`,
                    }}
                  >
                    {c.tag}
                  </span>
