...
export default async function LandingPricing({
  ...
  const rows: {
    ...
    {
      label: t("bridgePricingTblMembers"),
      desc: t("bridgePricingTblMembersDesc"),
      icon: Users,
      cells: ["2", "5", "15", tU],
    },
    {
      label: t("bridgePricingTblWorkspaces"),
      desc: t("bridgePricingTblWorkspacesDesc"),
      icon: FolderTree,
      cells: ["2", tU, tU, tU],
    },
    {
      label: t("bridgePricingTblPages"),
      desc: t("bridgePricingTblPagesDesc"),
      icon: Table2,
      cells: [true, true, true, true],
    },
    {
      label: t("bridgePricingTblAgents"),
      desc: t("bridgePricingTblAgentsDesc"),
      icon: Bot,
      cells: ["2", "5", tU, tU],
    },
    {
      label: t("bridgePricingTblMcp"),
      desc: t("bridgePricingTblMcpDesc"),
      icon: Plug,
      cells: [true, true, true, true],
    },
    {
      label: t("bridgePricingTblStorage"),
      desc: t("bridgePricingTblStorageDesc"),
      icon: HardDrive,
      cells: ["512 MB", "5 GB", "20 GB", tCustom],
    },
    {
      label: t("bridgePricingTblAudit"),
      desc: t("bridgePricingTblAuditDesc"),
      icon: ScrollText,
      cells: [
        t("bridgePricingTblAudit7"),
        t("bridgePricingTblAudit30"),
        t("bridgePricingTblAudit90"),
        tCustom,
      ],
    },
    {
      label: t("bridgePricingTblSharing"),
      desc: t("bridgePricingTblSharingDesc"),
      icon: Share2,
      cells: [true, true, true, true],
    },
    {
      label: t("bridgePricingTblSeo"),
      desc: t("bridgePricingTblSeoDesc"),
      icon: Globe,
      cells: [false, false, true, true],
    },
    {
      label: t("bridgePricingTblMemberMgmt"),
      desc: t("bridgePricingTblMemberMgmtDesc"),
      icon: UserCog,
      cells: [true, true, true, true],
    },
    {
      label: t("bridgePricingTblStorageView"),
      desc: t("bridgePricingTblStorageViewDesc"),
      icon: Gauge,
      cells: [true, true, true, true],
    },
    {
      label: t("bridgePricingTblSso"),
      desc: t("bridgePricingTblSsoDesc"),
      icon: KeyRound,
      cells: [false, false, false, true],
    },
    {
      label: t("bridgePricingTblSupport"),
      desc: t("bridgePricingTblSupportDesc"),
      icon: LifeBuoy,
      cells: [
        t("bridgePricingTblSupportCommunity"),
        t("bridgePricingTblSupportEmail"),
        t("bridgePricingTblSupportPriority"),
        t("bridgePricingTblSupportDedicated"),
      ],
    },
  ];
  const colTitles = [
      ...
      <div className="max-w-7xl mx-auto mt-10 lg:mt-12">
        ...
        <div className="mt-4 lg:mt-5 rounded-xl border border-neutral-800 overflow-hidden">
          <div className="flex flex-col lg:flex-row lg:items-center gap-4 lg:gap-8 px-6 lg:px-8 py-5 lg:py-6 bg-neutral-850">
            <div className="flex items-center gap-2.5 shrink-0">
              <GithubIcon size={16} />
              <span className="font-semibold text-neutral-100 text-[14px]">
                {t("bridgePricingSelfTitle")}
              </span>
            </div>
            <p className="m-0 text-[12.5px] text-dim shrink-0">
              {t("bridgePricingSelfSub")}
            </p>
            ...
            <a
              href="https://github.com/Ranork/corpus-app"
              target="_blank"
            ...
            >
              ...
              <span aria-hidden className="text-dim text-[11px]">
                ↗
              </span>
            </a>
          </div>
        ...
        {showComparison ? (
          <div id="compare" className="mt-12 lg:mt-16 scroll-mt-24">
            <h3
              className="m-0 mb-6 font-sans font-semibold text-neutral-100 text-[20px] lg:text-[24px]"
                  ...
                  <tr className="border-b border-neutral-800">
                    ...
                    {colTitles.map((title, i) => (
                      <th
                        ...
                        style={
                          i === 1
                            ? { background: "rgba(68,92,149,0.07)" }
                            : undefined
                        }
                      >
                        {title}
  ...
  return (
    <div
      className={`relative flex flex-col h-full rounded-xl border ${
        featured
          ? "pricing-card-featured p-6 lg:p-8 lg:-my-4 lg:z-10"
          : "p-6 lg:p-7"
      }`}
      style={
        featured
          ? {
              ...
              boxShadow:
                "0 0 0 1px rgba(68,92,149,0.15) inset, 0 24px 56px -16px rgba(68,92,149,0.3)",
            }
          : {
    ...
    >
      <div className="flex items-center justify-between mb-4">
        <span
          className="font-semibold text-neutral-100 text-[19px] lg:text-[21px]"
      ...
      <p className="m-0 mb-6 text-dim text-[13px] leading-[1.6] min-h-[42px]">
        {sub}
      </p>

      {originalPrice && discountLabel && (
        <div className="mb-2 flex items-center gap-2.5">
          <span className="font-mono text-[12px] text-dim line-through">
            {originalPrice}
          </span>
          <span
            ...
            style={{
              color: "var(--color-amber-500)",
              background: "rgba(204,125,69,0.13)",
            }}
          >
            {discountLabel}
          </span>
      ...
      <div className="mb-6 flex items-end gap-2">
        ...
        {priceSub && (
          <span className="font-mono text-[12px] text-dim mb-1.5">
            {priceSub}
          </span>
        )}
      </div>
      ...
      <ul className="flex flex-col gap-2.5 flex-1 mb-6">
        {features.map((feat) => (
          <li
            key={feat}
            className="flex gap-2.5 items-start text-[13.5px] text-neutral-50"
          >
...
function CheckIcon({ color, inline }: { color: string; inline?: boolean }) {
  return (
    <svg
      ...
      className={inline ? "inline-block" : "shrink-0 mt-0.5"}
    >
