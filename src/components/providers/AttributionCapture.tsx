 ...
 * referrer are present, stashes them in a `corpus_first_touch` cookie (90 days,
...
export default function AttributionCapture() {
  useEffect(() => {
    ...
    if (
      document.cookie
        .split("; ")
        .some((c) => c.startsWith("corpus_first_touch="))
    )
      return;
    ...
    document.cookie = `corpus_first_touch=${val}; path=/; max-age=${60 * 60 * 24 * 90}; samesite=lax`;
  }, []);
